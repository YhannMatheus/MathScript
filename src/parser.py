...
class Parser:
    ...
    def parse(self):
        ...
        while self.current_token:
            ...
            elif self.current_token.tipo == "IDENT" and self.peek_next() and self.peek_next().tipo in [":=", "+=", "-=", "*=", "/=", "**=", "//=", "%="]:
                statements.append(self.parse_assignment())
            elif self.current_token.tipo == "IDENT" and self.peek_next() and self.peek_next().tipo == "LPAREN":
    ...
    def parse_if_statement(self):
        ...
        then_block = self.parse_block(end_token="RBRACE") # Pass RBRACE as the end token
    ...
    def parse_block(self, end_token=None):
        print(f"DEBUG: parse_block token atual: {self.current_token}")
        statements = []
    ...
    def parse_comparison(self):
        ...
        while self.current_token and self.current_token.tipo in ["EQ", "NEQ", "LT", "GT", "LTE", "GTE"]:
            op = self.current_token.valor
            self.advance()
